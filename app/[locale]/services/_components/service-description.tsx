...
const ServiceDescription = ({
    ...
    const { ref, inView, entry } = useInView({
      ...
      return (
        <motion.div
          className="w-full self-center justify-items-center  p-2"
        ...
        >
          ...
          <ol className="flex flex-col gap-2 text-gray-600 text-[18px] p-6">
            {list?.map((item, index) => (
          ...
          {/* <Link href={serviceHref} className="w-fit" >
