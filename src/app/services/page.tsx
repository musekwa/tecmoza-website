...
const serviceImage = [
  ...
  },
  {
    ...
    list: [
      "Treinamos de forma ponctual empresas e pessoas singulares a aumentarem a sua literacia digital.",
      "Mentoramos de forma prolongada empresas e pessoas singulares na adocao de novas tecnologias.",
